...
class AISignalGenerator:
    """AI-powered signal generator using OpenAI/Anthropic"""
    ...
    def __init__(self, config):
        ...
        if config.ANTHROPIC_API_KEY:
            try:
                ...
                self.logger.info("✅ Anthropic API initialized")
            except Exception as e:
    ...
    def _prepare_market_context(self, symbol, data):
        ...
        volume_change = ((latest.get('tick_volume', 100) - prev_5.get('tick_volume', [100]).mean()) / prev_5.get('tick_volume', [100]).mean()) * 100
...
"""
    ...
    def _generate_advanced_technical_signal(self, symbol, context):
        ...
        price_change = context.get('price_change_percent', 0)
        if price_change > 1:
            score += 1
        ...
        # Volume Analysis
        volume_change = context.get('volume_change_percent', 0)
